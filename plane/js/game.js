...
game.states.preload=function(){
    this.preload=function(){
        ...
        game.load.image('bullet','../assets/bg.jpg');
...
game.states.play=function(){
    this.create=function(){
        ...
        //挂了的音乐
        this.dieSound=game.add.audio('ao',10,false);
        //接到了奖的音乐
        this.dong=game.add.audio('deng',10,false);
    }
    this.onStart=function(){
        ...
        this.dead=function(){
            ...
            try{
                ...
                var anim=myexplode.animations.add('mywxplode');
...
game.states.over=function(){
    this.create=function(){
        ...
        //重来按钮
        this.replaybutton=game.add.button(30,30,'replaybutton',this.onReplayClick,this,0,0,1);
        this.normalback=game.add.audio('mormalback',0.2,true);
        this.normalback.play();
    }
    //重新开始游戏
